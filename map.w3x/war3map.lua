...
function InitSounds()
    gg_snd_BattlenetBirth1 = CreateSound("Sound/Interface/BattlenetBirth1.flac", false, false, false, 0, 0, "SpellsEAX")
    SetSoundParamsFromLabel(gg_snd_BattlenetBirth1, "GlueScreenBNetClose")
    SetSoundDuration(gg_snd_BattlenetBirth1, 2432)
    SetSoundVolume(gg_snd_BattlenetBirth1, 127)
