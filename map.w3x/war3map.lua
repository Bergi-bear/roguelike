...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("opeo"), -2368.3, 2109.4, 102.077, FourCC("opeo"))
    u = BlzCreateUnitWithSkin(p, FourCC("hfoo"), -2223.6, 1952.9, 121.908, FourCC("hfoo"))
end
...
function CreateUnitsForPlayer1()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -1799.8, 2593.3, 126.240, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -1737.2, 1495.6, 126.240, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -3009.5, 1485.5, 126.240, FourCC("hpea"))
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), -2989.6, 2754.0, 126.240, FourCC("hpea"))
end
