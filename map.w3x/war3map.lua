...
function CreateRegions()
    local we
    gg_rct_Region_000 = Rect(4352.0, -9600.0, 7008.0, -7744.0)
    gg_rct_Region_001 = Rect(5856.0, -8128.0, 5920.0, -8064.0)
    gg_rct_Region_002 = Rect(6304.0, -8192.0, 6368.0, -8128.0)
    gg_rct_Region_003 = Rect(5440.0, -8096.0, 5504.0, -8032.0)
    gg_rct_Region_004 = Rect(6464.0, -9024.0, 6624.0, -8992.0)
    gg_rct_Region_005 = Rect(6624.0, -8960.0, 6688.0, -8896.0)
end
...
function main()
    SetCameraBounds(512.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -14336.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 12800.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -2048.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 512.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -2048.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 12800.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -14336.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
...
function config()
    ...
    DefineStartLocation(0, 6400.0, -8576.0)
