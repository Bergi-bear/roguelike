...
function CreateRegions()
    ...
    gg_rct_B1A_Copy = Rect(17856.0, -13248.0, 18048.0, -13088.0)
    gg_rct_B1A_Copy_2 = Rect(13504.0, -10080.0, 15552.0, -9120.0)
end
...
function config()
    ...
    DefineStartLocation(0, 5760.0, -8192.0)
